...
class SalesTrxLines (Base):
    ...
    transaction_line_id = Column('transaction_line_id', Integer, Sequence('sales_trx_lines_sequence', schema='apps') , primary_key = True)
    transaction_header_id = Column('transaction_header_id', Integer,ForeignKey('apps.sales_trx_header_tbl.transaction_header_id'))    
    ...
    sales_trx_header = relationship("model.SalesTrxHeader.SalesTrxHeader", back_populates="sales_trx_lines")